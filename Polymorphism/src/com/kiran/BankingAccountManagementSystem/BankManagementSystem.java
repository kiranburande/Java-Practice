...
public class BankManagementSystem 
{
	...
	{
		SavingsAccount savingsAccount = new SavingsAccount("456787456",5000.00,18.5);
		savingsAccount.generateStatement();
		System.out.println("------------------------");
		
		CheckingAccount checkingAccount = new CheckingAccount("456787456",5000.00,4000.00);
...
Implement methods:
generateStatement() : The generateStatement() method in the Account class serves as a generic statement generator for all types of accounts. 
It prints a message with the account number and current balance. The covariant return type is used to return an Account object. 
...
Override the generateStatement(): In the SavingsAccount subclass, the generateStatement() method is overridden to  prints the account number,
 current balance, and the interest rate for the savings account. It utilizes the covariant return type to return a SavingsAccount object.
