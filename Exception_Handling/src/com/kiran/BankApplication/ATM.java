...
public class ATM {
	...
	public static void main(String[] args) 
	{
		...
		BankAccount bankAccount =new BankAccount(8989898,2000);
		Customer customer = new Customer("Kiran Burande", bankAccount);
		...
		case 3:{
			...
			double amt = sc.nextDouble();
			try {
				bankAccount.transfer(bankAccount, amt);
