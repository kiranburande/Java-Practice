package com.kiran.ClassCastException;

public class ClassCastExceptionDemo 
{
	public static void handleClassCastException()
	{
		//Object []arr = {"Hello", "World", "Java"}; // Case 1:
		//Object []arr = {"Hello", 123, "Java"};  // Case 2:
		Object []arr = {"Hello", true, "Java"}; // Case 3:
		for(Object obj : arr)
		{
			try 
			{
...
Objective:
Write a Java program that demonstrates how to handle ClassCastException. The program should include a method that attempts to 
cast an object of one type to another incompatible type. If a ClassCastException occurs, it should be caught and an appropriate message should be displayed.
