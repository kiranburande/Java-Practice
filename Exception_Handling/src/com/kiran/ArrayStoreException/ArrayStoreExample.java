package com.kiran.ArrayStoreException;
...
//		stringArray[2]="Java";
	...
	public static void main(String[] args) 
	{
		...
		{
			System.err.println("ArrayStoreException caught: Incompatible type: "+e.getMessage()+" cannot be stored in an array of java.lang.String");
		}
	}
}
...
Objective:
Write a Java program that demonstrates how to handle ArrayStoreException. The program should include a method 
that attempts to store objects of incompatible types into an array of String[]. Implement exception handling 
in the main method to catch and handle this exception.
