...
Objective:
Write a Java program that demonstrates how to handle ClassNotFoundException. The program should prompt the 
user to enter a class name and attempt to load that class using reflection. If the class does not exist, the 
program should catch the exception and print an appropriate message.
